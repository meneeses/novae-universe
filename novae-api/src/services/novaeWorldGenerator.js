...
export function getNovaeWorldType(commitCount = 0) {
...
export function getNovaeWorldSize(commitCount = 0) {
...
export function generateNovaeWorldFromRepo(repo, starId, username, index) {
  ...
  return {
    ...
    world_type: getNovaeWorldType(commitCount),
    ...
    _size: getNovaeWorldSize(commitCount),
